scoreboard players set .Music cooldown 3165
scoreboard players set -Music:Strad options 0
...
stopsound @a
execute at @e[tag=base] run playsound music_disc.strad ambient @a ~ ~ ~ 100