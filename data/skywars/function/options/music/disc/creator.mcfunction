scoreboard players set .Music cooldown 3525
scoreboard players set -Music:Creator options 0
...
stopsound @a
execute at @e[tag=base] run playsound music_disc.creator ambient @a ~ ~ ~ 100