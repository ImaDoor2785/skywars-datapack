scoreboard players set .Music cooldown 3505
scoreboard players set -Music:Tears options 0
...
stopsound @a
execute at @e[tag=base] run playsound music_disc.tears ambient @a ~ ~ ~ 100