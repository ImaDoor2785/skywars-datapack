scoreboard players set .Music cooldown 3005
scoreboard players set -Music:Stal options 0
...
stopsound @a
execute at @e[tag=base] run playsound music_disc.stal ambient @a ~ ~ ~ 100