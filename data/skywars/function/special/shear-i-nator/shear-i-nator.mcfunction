...
execute if score @s shear_i_nator_cooldown matches 1.. run title @s actionbar {"text":"Shear-I-Nator on cooldown","color":"red"}
execute unless score @s shear_i_nator_cooldown matches 1.. run tag @s add shearer
execute unless score @s shear_i_nator_cooldown matches 1.. run tag @p[tag=!spectator,tag=!shearer,limit=1] add sheared
...
execute unless score @s shear_i_nator_cooldown matches 1.. run scoreboard players set @s shear_i_nator_cooldown 200
